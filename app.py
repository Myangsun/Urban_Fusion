...
class UrbanFusionApp:
    ...
    def __init__(self, data_dir="data"):
        ...
        self.database = MultimodalDatabase(
            db_path=os.path.join(data_dir, "embeddings"))
    ...
    def process_query(self, query: str) -> dict:
        ...
        output_path = os.path.join(
            self.data_dir, "output", "query_result.json")
    ...
    def analyze_data(self, csv_path: str = None) -> dict:
        ...
        if csv_path is None:
            csv_path = os.path.join(
                self.data_dir, "sample", "talabat_sample.csv")
        ...
        self.data_processor.generate_visualization(
            results, bar_chart_path, "bar")
    ...
    def evaluate_locations(self, locations: list, constraints: dict) -> dict:
        ...
        # Analyze constraints
        filtered_locations = self.data_processor.analyze_constraints(
        ...
        self.data_processor.create_geospatial_visualization(
            filtered_locations, map_path)
    ...
    def run_demo(self):
        ...
        sample_locations = [
            {"lat": 25.2048, "lng": 55.2708, "rent": 5000, "competition_count": 3,
                "score": 0.8, "delivery_radius_check": True},
            {"lat": 25.2200, "lng": 55.3000, "rent": 7000, "competition_count": 1,
                "score": 0.9, "delivery_radius_check": True},
            {"lat": 25.1900, "lng": 55.2600, "rent": 6000, "competition_count": 5,
                "score": 0.6, "delivery_radius_check": False},
            {"lat": 25.1800, "lng": 55.2500, "rent": 4500,
                "competition_count": 2, "score": 0.7, "delivery_radius_check": True}
        ]
        ...
        evaluation_result = self.evaluate_locations(
            sample_locations, sample_constraints)
        ...
        print(
            f"Data analysis: {len(analysis_result['analysis_results'])} metrics calculated")
        print(
            f"Location evaluation: {evaluation_result['metrics']['filtered_locations']} locations passed constraints")
